...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.show_attributes);

        editText = (EditText) this.findViewById(ecomap.a2017.lahacks.sus.R.id.EventName);
        editText.setVisibility(View.GONE);
        editText2 = (EditText) this.findViewById(ecomap.a2017.lahacks.sus.R.id.EventDescr);
        ...
        mMapView.setOnTouchListener(new DefaultMapViewOnTouchListener(this, mMapView) {
            ...
            public boolean onSingleTapConfirmed(MotionEvent e) {
                ...
                final String Event = editText.getText().toString();
